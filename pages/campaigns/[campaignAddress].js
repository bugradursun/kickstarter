...
const CampaignShow = ({
    campaignAddress,minimumContribution,balance,requestCount,approversCount,manager,
}) => {
    ...
    const items = [
        ...
        },
        {
            ...
            description:"Minimum amount to contribute to this campaign in wei to become an approver",
            style:{overflowWrap:"break-word"},
        },
        {
    ...
    return(
        <Layout>
            ...
            <br/>
            <Button onClick={() => router.push(`/campaigns/${campaignAddress}/requests`)} color="teal" size="large">
                Show requests
            </Button>
        </Layout>
    )
